...
$( document ).ready(function() {
    console.log( "Welcome To Songify-Voice-Controlled-Music-App" );
    speechRs.speechinit('Google हिन्दी',function(e){
	        speechRs.speak("Hi,Welcome to Songify Voice Controlled Music App, Please Enter Your Name to Further Proceed.", function() {
                   //speaking completed.
               }, false);
      });
...
// it check wheather the Song status paused or not if paused it plays if not it paused.
  if(song.paused == true) {
	...
	speechRs.speechinit('Google हिन्दी',function(e){
	        speechRs.speak("Playing Music", function() {
                   //speaking completed.
               }, false);
     });
      ...
      $.ajax({
        ...
        'success': function (responseData) {
          ...
          error: function (responseData) {
                alert("Sorry Response From Backend could not be fetched !! Server Connection Issue !! ..");
                 speechRs.speechinit('Google हिन्दी',function(e){
...
function doSomething() {
        ...
        if (name.length > 3) {
			...
			var Salutation="Hello,"+name+",My name is Sarthak. Hope You Feel Good.Lets Play Some Music";
     speechRs.speechinit('Google हिन्दी',function(e){
		...
		toggleSong();
            ...
            $('#name-input').addClass('error');
			 alert ("Please Enter Your Name To Further Access (3 Character atleast required) !!!");
			  speechRs.speechinit('Google हिन्दी',function(e){
	        speechRs.speak("Please Enter Your Name To Further Access. ", function() {
                   //speaking completed.
               }, false);
     });
        }
